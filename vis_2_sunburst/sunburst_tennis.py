...
def renderGuidance():
    return html.Div(children=[
                html.H6(style={'margin-right': '55px'}, children=['Legends']),
                html.Img(
                    src=app.get_asset_url('image_reference.png'), 
...
def renderClickData(renderObject=None):
    if(renderObject is not None):
       ...
       # clickDataHtml = html.Div(html.Img(src=app.get_asset_url('image_reference.png'), style={'width': '350px', 'height': '300px'}))
       clickDataHtml = renderGuidance()
